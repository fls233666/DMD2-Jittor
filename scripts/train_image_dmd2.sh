...
DMD2_SAFE_UPSAMPLE="${DMD2_SAFE_UPSAMPLE:-1}"
DMD2_SAFE_LINEAR="${DMD2_SAFE_LINEAR:-0}"
DMD2_SAFE_CONCAT="${DMD2_SAFE_CONCAT:-1}"
DMD2_SAFE_POINTWISE_CONV="${DMD2_SAFE_POINTWISE_CONV:-0}"
DMD2_SAFE_POINTWISE_CONV_INPUT_GRAD="${DMD2_SAFE_POINTWISE_CONV_INPUT_GRAD:-1}"
DMD2_SAFE_POINTWISE_CONV_WEIGHT_GRAD="${DMD2_SAFE_POINTWISE_CONV_WEIGHT_GRAD:-1}"
DMD2_SAFE_POINTWISE_CONV_CODE_GRAD="${DMD2_SAFE_POINTWISE_CONV_CODE_GRAD:-0}"
DMD2_SAFE_POINTWISE_CONV_DW_MODE="${DMD2_SAFE_POINTWISE_CONV_DW_MODE:-cudnn}"
DMD2_SAFE_POINTWISE_CONV_DW_CHUNK="${DMD2_SAFE_POINTWISE_CONV_DW_CHUNK:-32}"
DMD2_SAFE_LEARNED_CONV="${DMD2_SAFE_LEARNED_CONV:-0}"
DMD2_SAFE_LEARNED_CONV_INPUT_GRAD="${DMD2_SAFE_LEARNED_CONV_INPUT_GRAD:-1}"
DMD2_SAFE_LEARNED_CONV_WEIGHT_GRAD="${DMD2_SAFE_LEARNED_CONV_WEIGHT_GRAD:-1}"
DMD2_SAFE_LEARNED_CONV_DW_MODE="${DMD2_SAFE_LEARNED_CONV_DW_MODE:-cudnn}"
DMD2_SAFE_LEARNED_CONV_DW_CHUNK="${DMD2_SAFE_LEARNED_CONV_DW_CHUNK:-32}"
DMD2_SAFE_LEARNED_CONV_DW_OUT_CHUNK="${DMD2_SAFE_LEARNED_CONV_DW_OUT_CHUNK:-32}"
DMD2_SAFE_ATTENTION_VALUE="${DMD2_SAFE_ATTENTION_VALUE:-1}"
DMD2_SYNC_DEBUG="${DMD2_SYNC_DEBUG:-0}"
...
export DMD2_SAFE_UPSAMPLE
export DMD2_SAFE_LINEAR
export DMD2_SAFE_CONCAT
export DMD2_SAFE_POINTWISE_CONV
export DMD2_SAFE_POINTWISE_CONV_INPUT_GRAD
export DMD2_SAFE_POINTWISE_CONV_WEIGHT_GRAD
export DMD2_SAFE_POINTWISE_CONV_CODE_GRAD
export DMD2_SAFE_POINTWISE_CONV_DW_MODE
export DMD2_SAFE_POINTWISE_CONV_DW_CHUNK
export DMD2_SAFE_LEARNED_CONV
export DMD2_SAFE_LEARNED_CONV_INPUT_GRAD
export DMD2_SAFE_LEARNED_CONV_WEIGHT_GRAD
export DMD2_SAFE_LEARNED_CONV_DW_MODE
export DMD2_SAFE_LEARNED_CONV_DW_CHUNK
